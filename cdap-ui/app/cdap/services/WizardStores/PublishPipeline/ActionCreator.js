...
const fetchPipelineConfig = ({ entityName, entityVersion, filename, marketName }) => {
  return MyMarketApi.getSampleData({ entityName, entityVersion, filename, marketName }).subscribe((res) => {
